...
from fol.loss_functions.thermal_3D_fe_hex_nonlin import ThermalLoss3D
...
def main(fol_num_epochs=10,solve_FE=False,clean_dir=False):
    ...
    # create thermal loss
    thermal_loss_3d = ThermalLoss3D("thermal_loss_3d",fe_model,{"beta":0,"c":4})
    ...
    # solve FE here
    if solve_FE: 
        first_fe_solver = NonLinearSolver("first_fe_solver",thermal_loss_3d,relative_error=1e-5,absolute_error=1e-5,max_num_itr=10,load_incr=2)
