...
def main(fol_num_epochs=10,solve_FE=False,clean_dir=False):
    ...
    fol = FiniteElementOperatorLearning("fol",no_control,[thermal_loss_2d],[1],
    ...
    for i in range(num_steps):
        fol.Train(loss_functions_weights=[1],X_train=FOL_T_temp.reshape(-1,1).T,batch_size=1,num_epochs=fol_num_epochs,
        ...
        FOL_T[:,i] = FOL_T_temp
        fol = FiniteElementOperatorLearning("fol",no_control,[thermal_loss_2d],[1],
                                        "swish",load_NN_params=True,
                                        NN_params_file_name="NN_params_"+working_directory_name+".npy",
