...
working_directory_name = "parametric_learning_results"
...
# add intended BCs to the end of samples
...
num_epoch_list = [2000,2000,2000,2000,100000]
fol_batch_size = 10
for i,learning_rate in enumerate(learning_rate_list):
    ...
    fol = FiniteElementOperatorLearning("first_fol",displ_control,[mechanical_loss_3d],
                                        [100,100],"tanh",load_NN_params=load_params,working_directory=working_directory_name,
