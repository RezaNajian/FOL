...
def main(fol_num_epochs=10,solve_FE=False,clean_dir=False):
    ...
    working_directory_name = 'mechanical_2D_poly_nonlin'
    ...
    voronoi_control_settings = {"numberof_seeds":5,"k_rangeof_values":list(np.arange(10,200,10))}
