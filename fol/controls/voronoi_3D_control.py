...
class VoronoiControl3D(Control):
    ...
    def Initialize(self) -> None:
        ...
        self.dim = self.fe_mesh.GetNodesCoordinates().shape[1]
        # number dim + 1 stands for the following: x coordinates array, y (and z), and E values
        self.num_control_vars = self.number_of_seeds * (self.dim + 1) 
