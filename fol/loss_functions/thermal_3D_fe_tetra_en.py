...
class ThermalLoss3DTetraEnergy(FiniteElementLoss):
    ...
    def ComputeElement(self,xyze,de,te,body_force):
        ...
        def compute_at_gauss_point(xi,eta,zeta,total_weight):
            ...
            gp_f = total_weight * detJ *  0.0 *  Nf.reshape(-1,1) 
        ...
        element_residuals = Se @ te - Fe
        return  ((te.T @ element_residuals)[0,0]), 0.0 * (Se @ te - Fe), 0.0 * Se
